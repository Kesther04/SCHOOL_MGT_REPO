...
<form name="myform" method="post" action="senior_result_form.php">
...
<table width="100%">
<tr> 
    <td><span>FULLNAME:</span><input type="text"  name="full" required ></td>  
    ...
    <td><span>REG. NO.:</span><input type="text" name="reg" required  value="" ></td>
</tr>

<tr>
    <td><span>SESSION YEAR:</span> <input type="text" name="sess" required value=""  ></td>
    ...
    <select name="sub" required>
        ...
        <option>FINANCIAL_ACCOUNTING</option>
...
<tr>
    ...
    <input type="hidden" name="grade" readonly>
    <input type="hidden" name="remark" readonly>
